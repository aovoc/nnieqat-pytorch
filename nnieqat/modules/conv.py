...
class Conv1d(torch.nn.Conv1d):
    r"""A quantized version of :class:`~torch.nn.Conv1d`.
...
class Conv2d(torch.nn.Conv2d):
    r"""A quantized version of :class:`~torch.nn.Conv2d`.
...
class Conv3d(torch.nn.Conv3d):
    r"""A quantized version of :class:`~torch.nn.Conv3d`.
...
class ConvTranspose1d(torch.nn.ConvTranspose1d):
    r"""A quantized version of :class:`~torch.nn.ConvTranspose1d`.
...
class ConvTranspose2d(torch.nn.ConvTranspose1d):
    r"""A quantized version of :class:`~torch.nn.ConvTranspose2d`.
...
class ConvTranspose3d(torch.nn.ConvTranspose1d):
    r"""A quantized version of :class:`~torch.nn.ConvTranspose3d`.
